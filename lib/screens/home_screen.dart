...
import 'package:flutter_provider/custom_listile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.separated(
          ...
          separatorBuilder: (_, index) => CustomListile(
                color: context.read<ShopList>().items[index].color,
                name: context.read<ShopList>().items[index].name,
                count: context.watch<ShopList>().items[index].count,
                addbuttonPressed: () {
                  context
                      .read<ShopList>()
